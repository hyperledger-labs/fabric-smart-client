...
import (
	...
	iourc "github.com/hyperledger-labs/fabric-smart-client/integration/fabric/iou_runtime_config"
...
func NewTestSuite(commType fsc.P2PCommunicationType, nodeOpts *integration.ReplicationOptions, tlsEnabled bool) *TestSuite {
	return &TestSuite{TestSuite: integration.NewTestSuite(func() (*integration.Infrastructure, error) {
		return integration.Generate(StartPort(), integration.WithRaceDetection, iourc.Topology(&iourc.Opts{
			CommType:        commType,
