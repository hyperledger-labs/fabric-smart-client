...
func (o *NodeOptions) For(name string) []node.Option {
...
func NewTestSuite(sqlConfigs map[string]*sql.PostgresConfig, generator func() (*Infrastructure, error)) *TestSuite {
	return &TestSuite{
