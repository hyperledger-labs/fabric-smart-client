...
*/
func NewOrdered(terminationSignal os.Signal, members grouper.Members) *orderedGroup {
	return &orderedGroup{
...
func (g *orderedGroup) Members() grouper.Members {
	return g.members
}
...
func (g *orderedGroup) orderedStart(signals <-chan os.Signal) (os.Signal, grouper.ErrorTrace) {
...
func (g *orderedGroup) waitForSignal(signals <-chan os.Signal, errTrace grouper.ErrorTrace) (os.Signal, grouper.ErrorTrace) {
...
func (g *orderedGroup) stop(signal os.Signal, signals <-chan os.Signal, errTrace grouper.ErrorTrace) error {
	errOccurred := false
