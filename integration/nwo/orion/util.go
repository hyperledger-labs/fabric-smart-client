...
const (
	interopCCPath = `https://github.com/hyperledger-labs/orion-dlt-interoperability/archive/refs/tags/core/network/fabric-interop-cc/contracts/interop/v1.2.2.zip`
)

func packageChaincode() (tmpDir string, cleanup func(), err error) {
	metadataContent := `{"path":"github.com/hyperledger-labs/orion-dlt-interoperability/core/network/fabric-interop-cc/contracts/interop","type":"golang","label":"interop"}`
	_ = metadataContent
