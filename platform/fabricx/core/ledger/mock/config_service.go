...
func (fake *ConfigService) NetworkClientTLS() grpc.SecureOptions {
...
func (fake *ConfigService) NetworkClientTLSCallCount() int {
	fake.networkClientTLSMutex.RLock()
	defer fake.networkClientTLSMutex.RUnlock()
	return len(fake.networkClientTLSArgsForCall)
}

func (fake *ConfigService) NetworkClientTLSCalls(stub func() grpc.SecureOptions) {
	fake.networkClientTLSMutex.Lock()
	defer fake.networkClientTLSMutex.Unlock()
	fake.NetworkClientTLSStub = stub
}

func (fake *ConfigService) NetworkClientTLSReturns(result1 grpc.SecureOptions) {
	fake.networkClientTLSMutex.Lock()
	defer fake.networkClientTLSMutex.Unlock()
...
func (fake *ConfigService) NetworkClientTLSReturnsOnCall(i int, result1 grpc.SecureOptions) {
	fake.networkClientTLSMutex.Lock()
	defer fake.networkClientTLSMutex.Unlock()
	fake.NetworkClientTLSStub = nil
...
func (fake *ConfigService) RawSubtree(arg1 string) (map[string]any, bool) {
...
func (fake *ConfigService) RawSubtreeCallCount() int {
	fake.rawSubtreeMutex.RLock()
	defer fake.rawSubtreeMutex.RUnlock()
	return len(fake.rawSubtreeArgsForCall)
}

func (fake *ConfigService) RawSubtreeCalls(stub func(string) (map[string]any, bool)) {
	fake.rawSubtreeMutex.Lock()
	defer fake.rawSubtreeMutex.Unlock()
	fake.RawSubtreeStub = stub
}

func (fake *ConfigService) RawSubtreeArgsForCall(i int) string {
	fake.rawSubtreeMutex.RLock()
	defer fake.rawSubtreeMutex.RUnlock()
...
func (fake *ConfigService) RawSubtreeReturns(result1 map[string]any, result2 bool) {
	fake.rawSubtreeMutex.Lock()
	defer fake.rawSubtreeMutex.Unlock()
...
func (fake *ConfigService) RawSubtreeReturnsOnCall(i int, result1 map[string]any, result2 bool) {
	fake.rawSubtreeMutex.Lock()
	defer fake.rawSubtreeMutex.Unlock()
	fake.RawSubtreeStub = nil
...
func (fake *ConfigService) RawSubtrees(arg1 string) []map[string]any {
...
func (fake *ConfigService) RawSubtreesCallCount() int {
	fake.rawSubtreesMutex.RLock()
	defer fake.rawSubtreesMutex.RUnlock()
	return len(fake.rawSubtreesArgsForCall)
}

func (fake *ConfigService) RawSubtreesCalls(stub func(string) []map[string]any) {
	fake.rawSubtreesMutex.Lock()
	defer fake.rawSubtreesMutex.Unlock()
	fake.RawSubtreesStub = stub
}

func (fake *ConfigService) RawSubtreesArgsForCall(i int) string {
	fake.rawSubtreesMutex.RLock()
	defer fake.rawSubtreesMutex.RUnlock()
...
func (fake *ConfigService) RawSubtreesReturns(result1 []map[string]any) {
	fake.rawSubtreesMutex.Lock()
	defer fake.rawSubtreesMutex.Unlock()
...
func (fake *ConfigService) RawSubtreesReturnsOnCall(i int, result1 []map[string]any) {
	fake.rawSubtreesMutex.Lock()
	defer fake.rawSubtreesMutex.Unlock()
	fake.RawSubtreesStub = nil
...
func (fake *ConfigService) UnmarshalKey(arg1 string, arg2 any) error {
...
func (fake *ConfigService) UnmarshalKeyCalls(stub func(string, any) error) {
	fake.unmarshalKeyMutex.Lock()
	defer fake.unmarshalKeyMutex.Unlock()
	fake.UnmarshalKeyStub = stub
}

func (fake *ConfigService) UnmarshalKeyArgsForCall(i int) (string, any) {
	fake.unmarshalKeyMutex.RLock()
	defer fake.unmarshalKeyMutex.RUnlock()
