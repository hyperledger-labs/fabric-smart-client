...
func (c *Config) VaultPersistenceType() dbdriver.PersistenceType {
	return dbdriver.PersistenceType(c.configService.GetString("orion." + c.prefix + "vault.persistence.type"))
}
