...
// endpoints share the web listener and whatever TLS it has, which cannot express a plaintext
// metrics endpoint behind a TLS web listener; fsc.metrics.address gives them a listener whose
// TLS is resolved on its own.
