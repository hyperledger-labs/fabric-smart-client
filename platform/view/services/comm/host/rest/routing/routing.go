...
type ServiceDiscovery interface {
	LookupAll(ctx context.Context, id host2.PeerID) ([]host2.PeerIPAddress, bool)
	Lookup(ctx context.Context, id host2.PeerID) host2.PeerIPAddress
}

type IDRouter interface {
	Lookup(ctx context.Context, id host2.PeerID) ([]host2.PeerIPAddress, bool)
}
