...
func (fake *DisposableContext) Context() context.Context {
...
func (fake *DisposableContext) ContextCallCount() int {
	fake.contextMutex.RLock()
	defer fake.contextMutex.RUnlock()
	return len(fake.contextArgsForCall)
}

func (fake *DisposableContext) ContextCalls(stub func() context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
	fake.ContextStub = stub
}

func (fake *DisposableContext) ContextReturns(result1 context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
...
func (fake *DisposableContext) ContextReturnsOnCall(i int, result1 context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
	fake.ContextStub = nil
...
func (fake *DisposableContext) Dispose() {
...
func (fake *DisposableContext) DisposeCallCount() int {
	fake.disposeMutex.RLock()
	defer fake.disposeMutex.RUnlock()
	return len(fake.disposeArgsForCall)
}

func (fake *DisposableContext) DisposeCalls(stub func()) {
	fake.disposeMutex.Lock()
...
func (fake *DisposableContext) GetServiceCallCount() int {
...
func (fake *DisposableContext) GetSession(arg1 viewa.View, arg2 viewa.Identity, arg3 ...viewa.View) (viewa.Session, error) {
...
func (fake *DisposableContext) GetSessionCallCount() int {
	fake.getSessionMutex.RLock()
	defer fake.getSessionMutex.RUnlock()
	return len(fake.getSessionArgsForCall)
}

func (fake *DisposableContext) GetSessionCalls(stub func(viewa.View, viewa.Identity, ...viewa.View) (viewa.Session, error)) {
	fake.getSessionMutex.Lock()
	defer fake.getSessionMutex.Unlock()
	fake.GetSessionStub = stub
}

func (fake *DisposableContext) GetSessionArgsForCall(i int) (viewa.View, viewa.Identity, []viewa.View) {
	fake.getSessionMutex.RLock()
	defer fake.getSessionMutex.RUnlock()
...
func (fake *DisposableContext) GetSessionReturns(result1 viewa.Session, result2 error) {
	fake.getSessionMutex.Lock()
	defer fake.getSessionMutex.Unlock()
...
func (fake *DisposableContext) GetSessionReturnsOnCall(i int, result1 viewa.Session, result2 error) {
	fake.getSessionMutex.Lock()
	defer fake.getSessionMutex.Unlock()
	fake.GetSessionStub = nil
...
func (fake *DisposableContext) GetSessionByID(arg1 string, arg2 viewa.Identity) (viewa.Session, error) {
...
func (fake *DisposableContext) GetSessionByIDCallCount() int {
	fake.getSessionByIDMutex.RLock()
	defer fake.getSessionByIDMutex.RUnlock()
	return len(fake.getSessionByIDArgsForCall)
}

func (fake *DisposableContext) GetSessionByIDCalls(stub func(string, viewa.Identity) (viewa.Session, error)) {
	fake.getSessionByIDMutex.Lock()
	defer fake.getSessionByIDMutex.Unlock()
	fake.GetSessionByIDStub = stub
}

func (fake *DisposableContext) GetSessionByIDArgsForCall(i int) (string, viewa.Identity) {
	fake.getSessionByIDMutex.RLock()
	defer fake.getSessionByIDMutex.RUnlock()
...
func (fake *DisposableContext) GetSessionByIDReturns(result1 viewa.Session, result2 error) {
	fake.getSessionByIDMutex.Lock()
	defer fake.getSessionByIDMutex.Unlock()
...
func (fake *DisposableContext) GetSessionByIDReturnsOnCall(i int, result1 viewa.Session, result2 error) {
	fake.getSessionByIDMutex.Lock()
	defer fake.getSessionByIDMutex.Unlock()
	fake.GetSessionByIDStub = nil
...
func (fake *DisposableContext) ID() string {
	fake.iDMutex.Lock()
...
func (fake *DisposableContext) IDCallCount() int {
	fake.iDMutex.RLock()
	defer fake.iDMutex.RUnlock()
	return len(fake.iDArgsForCall)
}

func (fake *DisposableContext) IDCalls(stub func() string) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *DisposableContext) IDReturns(result1 string) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *DisposableContext) IDReturnsOnCall(i int, result1 string) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *DisposableContext) Initiator() viewa.View {
...
func (fake *DisposableContext) InitiatorCallCount() int {
	fake.initiatorMutex.RLock()
	defer fake.initiatorMutex.RUnlock()
	return len(fake.initiatorArgsForCall)
}

func (fake *DisposableContext) InitiatorCalls(stub func() viewa.View) {
	fake.initiatorMutex.Lock()
	defer fake.initiatorMutex.Unlock()
	fake.InitiatorStub = stub
}

func (fake *DisposableContext) InitiatorReturns(result1 viewa.View) {
	fake.initiatorMutex.Lock()
	defer fake.initiatorMutex.Unlock()
...
func (fake *DisposableContext) InitiatorReturnsOnCall(i int, result1 viewa.View) {
	fake.initiatorMutex.Lock()
	defer fake.initiatorMutex.Unlock()
	fake.InitiatorStub = nil
...
func (fake *DisposableContext) IsMe(arg1 viewa.Identity) bool {
	fake.isMeMutex.Lock()
...
func (fake *DisposableContext) IsMeCallCount() int {
	fake.isMeMutex.RLock()
	defer fake.isMeMutex.RUnlock()
	return len(fake.isMeArgsForCall)
}

func (fake *DisposableContext) IsMeCalls(stub func(viewa.Identity) bool) {
	fake.isMeMutex.Lock()
	defer fake.isMeMutex.Unlock()
	fake.IsMeStub = stub
}

func (fake *DisposableContext) IsMeArgsForCall(i int) viewa.Identity {
	fake.isMeMutex.RLock()
	defer fake.isMeMutex.RUnlock()
...
func (fake *DisposableContext) IsMeReturns(result1 bool) {
	fake.isMeMutex.Lock()
	defer fake.isMeMutex.Unlock()
	fake.IsMeStub = nil
...
func (fake *DisposableContext) IsMeReturnsOnCall(i int, result1 bool) {
	fake.isMeMutex.Lock()
	defer fake.isMeMutex.Unlock()
	fake.IsMeStub = nil
...
func (fake *DisposableContext) Me() viewa.Identity {
	fake.meMutex.Lock()
...
func (fake *DisposableContext) MeCallCount() int {
	fake.meMutex.RLock()
	defer fake.meMutex.RUnlock()
	return len(fake.meArgsForCall)
}

func (fake *DisposableContext) MeCalls(stub func() viewa.Identity) {
	fake.meMutex.Lock()
	defer fake.meMutex.Unlock()
	fake.MeStub = stub
}

func (fake *DisposableContext) MeReturns(result1 viewa.Identity) {
	fake.meMutex.Lock()
	defer fake.meMutex.Unlock()
	fake.MeStub = nil
...
func (fake *DisposableContext) MeReturnsOnCall(i int, result1 viewa.Identity) {
	fake.meMutex.Lock()
	defer fake.meMutex.Unlock()
	fake.MeStub = nil
...
func (fake *DisposableContext) OnError(arg1 func()) {
...
func (fake *DisposableContext) OnErrorCallCount() int {
	fake.onErrorMutex.RLock()
	defer fake.onErrorMutex.RUnlock()
	return len(fake.onErrorArgsForCall)
}

func (fake *DisposableContext) OnErrorCalls(stub func(func())) {
	fake.onErrorMutex.Lock()
	defer fake.onErrorMutex.Unlock()
	fake.OnErrorStub = stub
}

func (fake *DisposableContext) OnErrorArgsForCall(i int) func() {
	fake.onErrorMutex.RLock()
	defer fake.onErrorMutex.RUnlock()
...
func (fake *DisposableContext) PutSessionByID(arg1 string, arg2 viewa.Identity, arg3 viewa.Session) error {
...
func (fake *DisposableContext) PutSessionByIDCallCount() int {
	fake.putSessionByIDMutex.RLock()
	defer fake.putSessionByIDMutex.RUnlock()
	return len(fake.putSessionByIDArgsForCall)
}

func (fake *DisposableContext) PutSessionByIDCalls(stub func(string, viewa.Identity, viewa.Session) error) {
	fake.putSessionByIDMutex.Lock()
	defer fake.putSessionByIDMutex.Unlock()
	fake.PutSessionByIDStub = stub
}

func (fake *DisposableContext) PutSessionByIDArgsForCall(i int) (string, viewa.Identity, viewa.Session) {
	fake.putSessionByIDMutex.RLock()
	defer fake.putSessionByIDMutex.RUnlock()
...
func (fake *DisposableContext) PutSessionByIDReturns(result1 error) {
	fake.putSessionByIDMutex.Lock()
	defer fake.putSessionByIDMutex.Unlock()
...
func (fake *DisposableContext) PutSessionByIDReturnsOnCall(i int, result1 error) {
	fake.putSessionByIDMutex.Lock()
	defer fake.putSessionByIDMutex.Unlock()
	fake.PutSessionByIDStub = nil
...
func (fake *DisposableContext) RunViewCallCount() int {
...
func (fake *DisposableContext) RunViewArgsForCall(i int) (viewa.View, []viewa.RunViewOption) {
	fake.runViewMutex.RLock()
	defer fake.runViewMutex.RUnlock()
...
func (fake *DisposableContext) Session() viewa.Session {
...
func (fake *DisposableContext) SessionCallCount() int {
	fake.sessionMutex.RLock()
	defer fake.sessionMutex.RUnlock()
	return len(fake.sessionArgsForCall)
}

func (fake *DisposableContext) SessionCalls(stub func() viewa.Session) {
	fake.sessionMutex.Lock()
	defer fake.sessionMutex.Unlock()
	fake.SessionStub = stub
}

func (fake *DisposableContext) SessionReturns(result1 viewa.Session) {
	fake.sessionMutex.Lock()
	defer fake.sessionMutex.Unlock()
...
func (fake *DisposableContext) SessionReturnsOnCall(i int, result1 viewa.Session) {
	fake.sessionMutex.Lock()
	defer fake.sessionMutex.Unlock()
	fake.SessionStub = nil
...
func (fake *DisposableContext) StartSpanFrom(arg1 context.Context, arg2 string, arg3 ...trace.SpanStartOption) (context.Context, trace.Span) {
...
func (fake *DisposableContext) StartSpanFromCallCount() int {
	fake.startSpanFromMutex.RLock()
	defer fake.startSpanFromMutex.RUnlock()
	return len(fake.startSpanFromArgsForCall)
}

func (fake *DisposableContext) StartSpanFromCalls(stub func(context.Context, string, ...trace.SpanStartOption) (context.Context, trace.Span)) {
	fake.startSpanFromMutex.Lock()
	defer fake.startSpanFromMutex.Unlock()
	fake.StartSpanFromStub = stub
}

func (fake *DisposableContext) StartSpanFromArgsForCall(i int) (context.Context, string, []trace.SpanStartOption) {
	fake.startSpanFromMutex.RLock()
	defer fake.startSpanFromMutex.RUnlock()
...
func (fake *DisposableContext) StartSpanFromReturns(result1 context.Context, result2 trace.Span) {
	fake.startSpanFromMutex.Lock()
	defer fake.startSpanFromMutex.Unlock()
...
func (fake *DisposableContext) StartSpanFromReturnsOnCall(i int, result1 context.Context, result2 trace.Span) {
	fake.startSpanFromMutex.Lock()
	defer fake.startSpanFromMutex.Unlock()
	fake.StartSpanFromStub = nil
...
var _ view.DisposableContext = new(DisposableContext)
