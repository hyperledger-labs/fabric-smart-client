...
func (fake *Context) GetSession(arg1 viewa.View, arg2 viewa.Identity, arg3 ...viewa.View) (viewa.Session, error) {
...
func (fake *Context) GetSessionCalls(stub func(viewa.View, viewa.Identity, ...viewa.View) (viewa.Session, error)) {
	fake.getSessionMutex.Lock()
	defer fake.getSessionMutex.Unlock()
	fake.GetSessionStub = stub
}

func (fake *Context) GetSessionArgsForCall(i int) (viewa.View, viewa.Identity, []viewa.View) {
	fake.getSessionMutex.RLock()
	defer fake.getSessionMutex.RUnlock()
...
func (fake *Context) GetSessionReturns(result1 viewa.Session, result2 error) {
	fake.getSessionMutex.Lock()
	defer fake.getSessionMutex.Unlock()
...
func (fake *Context) GetSessionReturnsOnCall(i int, result1 viewa.Session, result2 error) {
	fake.getSessionMutex.Lock()
	defer fake.getSessionMutex.Unlock()
	fake.GetSessionStub = nil
...
func (fake *Context) GetSessionByID(arg1 string, arg2 viewa.Identity) (viewa.Session, error) {
...
func (fake *Context) GetSessionByIDCalls(stub func(string, viewa.Identity) (viewa.Session, error)) {
	fake.getSessionByIDMutex.Lock()
	defer fake.getSessionByIDMutex.Unlock()
	fake.GetSessionByIDStub = stub
}

func (fake *Context) GetSessionByIDArgsForCall(i int) (string, viewa.Identity) {
	fake.getSessionByIDMutex.RLock()
	defer fake.getSessionByIDMutex.RUnlock()
...
func (fake *Context) GetSessionByIDReturns(result1 viewa.Session, result2 error) {
	fake.getSessionByIDMutex.Lock()
	defer fake.getSessionByIDMutex.Unlock()
...
func (fake *Context) GetSessionByIDReturnsOnCall(i int, result1 viewa.Session, result2 error) {
	fake.getSessionByIDMutex.Lock()
	defer fake.getSessionByIDMutex.Unlock()
	fake.GetSessionByIDStub = nil
...
func (fake *Context) Initiator() viewa.View {
...
func (fake *Context) InitiatorCalls(stub func() viewa.View) {
	fake.initiatorMutex.Lock()
	defer fake.initiatorMutex.Unlock()
	fake.InitiatorStub = stub
}

func (fake *Context) InitiatorReturns(result1 viewa.View) {
	fake.initiatorMutex.Lock()
	defer fake.initiatorMutex.Unlock()
...
func (fake *Context) InitiatorReturnsOnCall(i int, result1 viewa.View) {
	fake.initiatorMutex.Lock()
	defer fake.initiatorMutex.Unlock()
	fake.InitiatorStub = nil
...
func (fake *Context) IsMe(arg1 viewa.Identity) bool {
	fake.isMeMutex.Lock()
...
func (fake *Context) IsMeCalls(stub func(viewa.Identity) bool) {
	fake.isMeMutex.Lock()
	defer fake.isMeMutex.Unlock()
	fake.IsMeStub = stub
}

func (fake *Context) IsMeArgsForCall(i int) viewa.Identity {
	fake.isMeMutex.RLock()
	defer fake.isMeMutex.RUnlock()
...
func (fake *Context) Me() viewa.Identity {
	fake.meMutex.Lock()
...
func (fake *Context) MeCalls(stub func() viewa.Identity) {
	fake.meMutex.Lock()
	defer fake.meMutex.Unlock()
	fake.MeStub = stub
}

func (fake *Context) MeReturns(result1 viewa.Identity) {
	fake.meMutex.Lock()
	defer fake.meMutex.Unlock()
	fake.MeStub = nil
...
func (fake *Context) MeReturnsOnCall(i int, result1 viewa.Identity) {
	fake.meMutex.Lock()
	defer fake.meMutex.Unlock()
	fake.MeStub = nil
...
func (fake *Context) RunView(arg1 viewa.View, arg2 ...viewa.RunViewOption) (any, error) {
...
func (fake *Context) RunViewCalls(stub func(viewa.View, ...viewa.RunViewOption) (any, error)) {
	fake.runViewMutex.Lock()
	defer fake.runViewMutex.Unlock()
	fake.RunViewStub = stub
}

func (fake *Context) RunViewArgsForCall(i int) (viewa.View, []viewa.RunViewOption) {
	fake.runViewMutex.RLock()
	defer fake.runViewMutex.RUnlock()
...
func (fake *Context) Session() viewa.Session {
...
func (fake *Context) SessionCalls(stub func() viewa.Session) {
	fake.sessionMutex.Lock()
	defer fake.sessionMutex.Unlock()
	fake.SessionStub = stub
}

func (fake *Context) SessionReturns(result1 viewa.Session) {
	fake.sessionMutex.Lock()
	defer fake.sessionMutex.Unlock()
...
func (fake *Context) SessionReturnsOnCall(i int, result1 viewa.Session) {
	fake.sessionMutex.Lock()
	defer fake.sessionMutex.Unlock()
	fake.SessionStub = nil
...
func (fake *Context) Invocations() map[string][][]any {
...
func (fake *Context) recordInvocation(key string, args []any) {
...
var _ view.ViewContext = new(Context)
