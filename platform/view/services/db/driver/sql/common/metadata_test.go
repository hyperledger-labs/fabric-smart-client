...
func mockMetadataStore(db *sql.DB) *common2.MetadataStore {
	return common2.NewMetadataStore(db, db, "test_table", &mock.SQLErrorWrapper{}, sqlite.NewConditionInterpreter())
}
