...
func mockEndorseTXStore(db *sql.DB) *common2.EndorseTxStore {
	return common2.NewEndorseTxStore(db, db, "test_table", &mock.SQLErrorWrapper{}, sqlite.NewConditionInterpreter())
}
