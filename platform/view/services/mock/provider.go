...
func (fake *ServiceProvider) GetService(arg1 any) (any, error) {
...
func (fake *ServiceProvider) GetServiceCalls(stub func(any) (any, error)) {
	fake.getServiceMutex.Lock()
	defer fake.getServiceMutex.Unlock()
	fake.GetServiceStub = stub
}

func (fake *ServiceProvider) GetServiceArgsForCall(i int) any {
	fake.getServiceMutex.RLock()
	defer fake.getServiceMutex.RUnlock()
...
func (fake *ServiceProvider) GetServiceReturns(result1 any, result2 error) {
	fake.getServiceMutex.Lock()
	defer fake.getServiceMutex.Unlock()
...
func (fake *ServiceProvider) GetServiceReturnsOnCall(i int, result1 any, result2 error) {
	fake.getServiceMutex.Lock()
	defer fake.getServiceMutex.Unlock()
	fake.GetServiceStub = nil
...
var _ services.Provider = new(ServiceProvider)
