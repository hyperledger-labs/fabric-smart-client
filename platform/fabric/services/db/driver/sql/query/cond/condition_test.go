...
import (
	...
	common3 "github.com/hyperledger-labs/fabric-smart-client/platform/fabric/services/db/driver/sql/query/common"
	cond2 "github.com/hyperledger-labs/fabric-smart-client/platform/fabric/services/db/driver/sql/query/cond"
...
func TestConditions(t *testing.T) { //nolint:paralleltest
	...
	for _, tc := range testMatrix {
		query, params := common3.NewBuilderWithOffset(common2.CopyPtr(0)).
			WriteConditionSerializable(tc.condition, newTestInterpreter()).
			Build()
