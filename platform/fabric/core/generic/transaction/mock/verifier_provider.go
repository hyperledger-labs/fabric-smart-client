...
func (fake *VerifierProvider) GetVerifier(arg1 view.Identity) (driver.Verifier, error) {
...
func (fake *VerifierProvider) GetVerifierCallCount() int {
	fake.getVerifierMutex.RLock()
	defer fake.getVerifierMutex.RUnlock()
	return len(fake.getVerifierArgsForCall)
}

func (fake *VerifierProvider) GetVerifierCalls(stub func(view.Identity) (driver.Verifier, error)) {
	fake.getVerifierMutex.Lock()
	defer fake.getVerifierMutex.Unlock()
	fake.GetVerifierStub = stub
}

func (fake *VerifierProvider) GetVerifierArgsForCall(i int) view.Identity {
	fake.getVerifierMutex.RLock()
	defer fake.getVerifierMutex.RUnlock()
...
func (fake *VerifierProvider) GetVerifierReturns(result1 driver.Verifier, result2 error) {
	fake.getVerifierMutex.Lock()
	defer fake.getVerifierMutex.Unlock()
...
func (fake *VerifierProvider) GetVerifierReturnsOnCall(i int, result1 driver.Verifier, result2 error) {
	fake.getVerifierMutex.Lock()
	defer fake.getVerifierMutex.Unlock()
	fake.GetVerifierStub = nil
...
func (fake *VerifierProvider) Invocations() map[string][][]interface{} {
...
func (fake *VerifierProvider) recordInvocation(key string, args []interface{}) {
...
var _ driver.VerifierProvider = new(VerifierProvider)
