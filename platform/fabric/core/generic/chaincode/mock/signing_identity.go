...
func (fake *SigningIdentity) GetPublicVersion() driver.VerifyingIdentity {
...
func (fake *SigningIdentity) GetPublicVersionCalls(stub func() driver.VerifyingIdentity) {
	fake.getPublicVersionMutex.Lock()
	defer fake.getPublicVersionMutex.Unlock()
	fake.GetPublicVersionStub = stub
}

func (fake *SigningIdentity) GetPublicVersionReturns(result1 driver.VerifyingIdentity) {
	fake.getPublicVersionMutex.Lock()
	defer fake.getPublicVersionMutex.Unlock()
...
func (fake *SigningIdentity) GetPublicVersionReturnsOnCall(i int, result1 driver.VerifyingIdentity) {
	fake.getPublicVersionMutex.Lock()
	defer fake.getPublicVersionMutex.Unlock()
	fake.GetPublicVersionStub = nil
...
var _ driver.SigningIdentity = new(SigningIdentity)
