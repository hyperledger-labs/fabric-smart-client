...
func NewDeliverClientForOrderer(channelID string, signer Signer, bestEffort bool) (*DeliverClient, error) {
...
func NewDeliverClientForPeer(channelID string, signer Signer, bestEffort bool) (*DeliverClient, error) {
	var tlsCertHash []byte
