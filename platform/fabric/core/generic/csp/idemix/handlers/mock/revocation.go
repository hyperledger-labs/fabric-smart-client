...
type Revocation struct {
	...
	SignStub        func(*ecdsa.PrivateKey, [][]byte, int, csp.RevocationAlgorithm) ([]byte, error)
	signMutex       sync.RWMutex
	signArgsForCall []struct {
		arg1 *ecdsa.PrivateKey
		arg2 [][]byte
		arg3 int
		arg4 csp.RevocationAlgorithm
	}
	signReturns struct {
		result1 []byte
		result2 error
	...
	VerifyStub        func(*ecdsa.PublicKey, []byte, int, csp.RevocationAlgorithm) error
...
func (fake *Revocation) Sign(arg1 *ecdsa.PrivateKey, arg2 [][]byte, arg3 int, arg4 csp.RevocationAlgorithm) ([]byte, error) {
	var arg2Copy [][]byte
	if arg2 != nil {
...
func (fake *Revocation) SignCalls(stub func(*ecdsa.PrivateKey, [][]byte, int, csp.RevocationAlgorithm) ([]byte, error)) {
	fake.signMutex.Lock()
	defer fake.signMutex.Unlock()
	fake.SignStub = stub
}

func (fake *Revocation) SignArgsForCall(i int) (*ecdsa.PrivateKey, [][]byte, int, csp.RevocationAlgorithm) {
	fake.signMutex.RLock()
	defer fake.signMutex.RUnlock()
...
func (fake *Revocation) Verify(arg1 *ecdsa.PublicKey, arg2 []byte, arg3 int, arg4 csp.RevocationAlgorithm) error {
	var arg2Copy []byte
	if arg2 != nil {
		arg2Copy = make([]byte, len(arg2))
		copy(arg2Copy, arg2)
...
func (fake *Revocation) VerifyCalls(stub func(*ecdsa.PublicKey, []byte, int, csp.RevocationAlgorithm) error) {
	fake.verifyMutex.Lock()
	defer fake.verifyMutex.Unlock()
	fake.VerifyStub = stub
}

func (fake *Revocation) VerifyArgsForCall(i int) (*ecdsa.PublicKey, []byte, int, csp.RevocationAlgorithm) {
	fake.verifyMutex.RLock()
	defer fake.verifyMutex.RUnlock()
