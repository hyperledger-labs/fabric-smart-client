...
func (o *IdemixNymKeyDerivationOpts) IssuerPublicKey() bccsp.Key {
	return o.IssuerPK
}
...
func (o *IdemixCredentialSignerOpts) IssuerPublicKey() bccsp.Key {
	return o.IssuerPK
}

type IdemixSignatureInfo struct {
	Disclosure []byte
	Attrs      [][]byte
	RAttrs     [][]byte
}
