...
func RegisterEmptyServiceServer(s grpc.ServiceRegistrar, srv EmptyServiceServer) {
	// If the following call panics, it indicates UnimplementedEmptyServiceServer was
...
var EmptyService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "platform/common/services/grpc/testpb/test.proto",
}
...
func (UnimplementedEchoServiceServer) EchoCall(context.Context, *Echo) (*Echo, error) {
	return nil, status.Error(codes.Unimplemented, "method EchoCall not implemented")
}
